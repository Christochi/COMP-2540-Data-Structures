public class BinarySearchTree 
{
   ...
   else 
   {
      ...
      while (true) 
      {
         // root is the top parent so we startthere
         parent = focusNode;
...
// }
 ...
 public Node search(int key)
 {
  ...
  public boolean remove(int key)
  {
     ...
     // When searching for a Node this 
     // tells whether to search to the  right or left

     boolean isItALeftChild = true;

     // While haven't found the Node keep looking
     while (focusNode.key != key) 
     {
        parent = focusNode;
