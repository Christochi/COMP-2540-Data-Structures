...
public class MergeSort
{
   ...
   public void sortQueue( MergeSort queue1, MergeSort queue2, MergeSort s )
   {
   ...
   public void mergeSort( MergeSort s )
   {
      int n = s.size();
      ...
      MergeSort queue1 = new MergeSort();
      MergeSort queue2 = new MergeSort();
